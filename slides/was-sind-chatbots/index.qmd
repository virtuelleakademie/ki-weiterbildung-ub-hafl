...
**Von Reaktion zu Reasoning**

::::{.columns}
:::{.column width="60%"}
Neuere Modelle (OpenAI o1/o3, Claude Extended Thinking) können vor der Antwort "nachdenken":
...
4. **Antwort generieren** - Basierend auf Denkprozess
...
::: {.callout-note}
**In eurem Kontext:** Thinking-Modus besonders nützlich für Lehrplanung, Fallanalysen, ethische Dilemmata.
:::
